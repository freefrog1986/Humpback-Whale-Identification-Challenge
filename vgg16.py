...
if __name__ == '__main__':
    ...
    train_images = glob(working_path + "/input/train/*jpg")
    test_images = glob(working_path + "/input/test/*jpg")
    df = pd.read_csv(working_path + "/input/train.csv")

    df["Image"] = df["Image"].map(lambda x : working_path + "/input/train/"+x)
